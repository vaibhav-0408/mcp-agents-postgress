from typing import Any,Annotated,List,Any
...
# database configration for plansom postgress
DB_CONFIG = {
...
# create a database connection using pool
class DatabaseConnection:
    ...
    # function to execute database query generated by agent
...
async def handle_list_tools() -> list[types.Tool]:
    ...
    return [
        types.Tool(
            ...
            description = f"""You are the POSTGRES AGENT, an advanced AI database retriever for PLANSOM, designed to execute PostgreSQL queries on the tables: goals and tasks. Your expertise lies in retrieving precise and relevant information from a PostgreSQL database based on the questions you receive. Your primary role is to understand the provided question, execute the necessary queries, and deliver accurate and professional responses by fetching the required data from the designated tables.
                  ...
                  ### Database Schema Overview:
                    ...
                    Key Fetching Logic:
                    - to Fetch *goals* by filtering goal_owner_id = {GOAL_OWNER_ID}.
        ...
        types.Tool(
            name='get-summary',
            description=f"""You are the SUMMARY AGENT, an advanced AI database retriever for PLANSOM, designed to Get summary of conversation of user based on his groups and goals from chromadb sqlite3 database Your expertise lies in retrieving precise and relevant information from a  database based on the questions you receive. Your primary role is to understand the provided question, execute the necessary queries, and deliver accurate and professional responses by fetching the required data from the designated tables.
            
            summary is stored in format of
                1.Date of summary
                2.thread_id of group
                3.Group name
                4.Main_goal name
                5.metadata means all summary
            ...
            inputSchema={
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "get summary of user from database",
                    },
                    "format": {
                        "type": "string",
                        "description": "Output format",
